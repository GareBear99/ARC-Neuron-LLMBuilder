...
Include ARC-StreamMemory as the visual/video memory add-on for all LLMs and ARC-style systems: frame hashes, visual RAG, AI-readable screen memory, module attachments, Omnibinary pointers, and Arc-RAR manifests.
